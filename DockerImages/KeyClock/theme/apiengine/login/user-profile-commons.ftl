<#--
  Copied from Keycloak base theme and lightly modified:
  - Keeps input names/ids consistent with Keycloak's user-profile system.
  - Does NOT auto-load html5DataAnnotations JS from this theme's resources path.
    (The base macro would reference `${url.resourcesPath}/js/...`, which we don't ship.)
-->
